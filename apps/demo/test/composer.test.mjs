...
assert.match(worker, /const OPERATOR_INSTRUCTION = "Operate APP_HARNESS\. Read getWorkItem\(\{workItemId\}\) and listActions\(\{workItemId\}\), then progress one step only: claim -> classification -> issue -> plan -> implementation -> candidate -> validating -> promotion -> deployed -> completed\./u, "the operator wake begins with the compact legal progression");
