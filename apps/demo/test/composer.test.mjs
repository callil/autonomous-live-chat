...
assert.match(worker, /const OPERATOR_CHAT_KEY = "operator-app-harness-v1"/u, "the persistent operator chat is bound to the complete App Harness capability schema");
