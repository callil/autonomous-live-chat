...
assert.match(worker, /const OPERATOR_CHAT_KEY = "ledger-operator"/u, "the persistent operator chat is bound to the exact App Harness capability schema");
assert.match(worker, /const OPERATOR_INSTRUCTION = "Operate the APP_HARNESS ledger\./u, "the operator wake begins with one stable, compact, tool-first instruction");
...
assert.match(worker, /const OPERATOR_GADGET_KEY = "app-harness-operator"/u, "the persistent operator workspace cannot retain an experimental APP_HARNESS binding");
