...
assert.match(worker, /const OPERATOR_CHAT_KEY = "ledger-operator-v2"/u, "the persistent operator chat is bound to the exact App Harness capability schema");
...
assert.match(worker, /const OPERATOR_GADGET_KEY = "app-harness-operator-v2"/u, "the persistent operator workspace cannot retain an experimental APP_HARNESS binding");
