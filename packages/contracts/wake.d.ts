...
export function queueOperatorWakeRecord(existing: OperatorWakeRecord | undefined, input: { id: string; workItemId: string; version: number; now: number; delayMs: number; turnFloor?: number }): OperatorWakeRecord;
