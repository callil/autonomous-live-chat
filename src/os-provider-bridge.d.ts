...
export function createOsNativeGitJob(input: { manifest: OsPlanningManifest; plan: { kind: "repository-task"; request: string }; parentBaseSha?: string | null }): OsNativeGitJob;
