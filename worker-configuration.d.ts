/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9bb713359f7b0b9f5823232f17ac1923)
...
interface __BaseEnv_Env {
	...
	OS_RESPONSE_TARGETS: DurableObjectNamespace<import("./src/index").OsWorkspaceResponseTarget>;
	OS_WORKSPACE: Service /* entrypoint ExternalMessageGateway from app-harness-os */;
	OS_NATIVE_GIT_RUNNER: Fetcher /* app-harness-os-native-git */;
	GITHUB_IDENTITY_BRIDGE: Fetcher /* app-harness-os-git-proxy */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ChatRoom" | "OsWorkspaceResponseTarget";
	}
