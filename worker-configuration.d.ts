/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 47d80d92232c4aaba4af464a85212362)
// Runtime types generated with workerd@1.20260801.1 2026-08-05 allow_irrevocable_stub_storage,nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	GITHUB_REPOSITORY: "callil/autonomous-live-chat";
	CHAT_ROOM: DurableObjectNamespace<import("./src/index").ChatRoom>;
	OS_WORKSPACE: Service /* entrypoint ExternalMessageGateway from app-harness-os */;
	OS_NATIVE_GIT_RUNNER: Service /* entrypoint NativeGitRunner from app-harness-os-native-git */;
	GITHUB_IDENTITY_BRIDGE: Fetcher /* app-harness-os-git-proxy */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_REPOSITORY">> {}
}
