...
assert.match(source, /RUNNER_IMAGE_REVISION = "da052-async011"/u, "the image revision changes with the agent replacement so no run resumes a stale NanoCodex sandbox");
assert.ok(`ah-da052-async011-${"x".repeat(32)}`.length <= 63, "derived Cloudflare Sandbox identities stay within the platform limit");
