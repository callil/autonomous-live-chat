...
export function buildNanocodexInstructions({ repository, issueNumber, branch, stackId, generation }) {
	...
	return [
		...
		`If genuinely dependent slices are needed, keep ${branch} as the bottom branch and use the official non-interactive gh stack workflow (gh stack init/add/submit --auto --open). Do not simulate a stack with unrelated PRs.`,
