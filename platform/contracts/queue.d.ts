export type RunState = "queued" | "running" | "verifying" | "merged" | "failed" | "parked";
...
export function beginVerifying(queue: QueuedRun[], input: { runId: string; attemptId: string; at: number }): QueuedRun[];
...
export function parkExpiredRun(queue: QueuedRun[], now: number, ttlMs?: number): { queue: QueuedRun[]; parked: QueuedRun | null };
