...
export type QueueChip = { intentId: string; phase: PipelinePhase; label: string; runId?: string; position?: number; etaMs?: number; anchor?: ChipAnchor; text?: string; by?: string };
export type AnchoredIntent = Intent & { anchor?: ChipAnchor; requestText?: string; requestedBy?: string };
