...
const pinnedJob = createOsNativeGitJob({ manifest, plan: { kind: "documentation-task", request: "Clarify the project intent in README." }, parentBaseSha: "a".repeat(40) });
...
assert.throws(() => createOsNativeGitJob({ manifest, plan: { kind: "documentation-task", request: "Clarify README." }, parentBaseSha: "main" }));
